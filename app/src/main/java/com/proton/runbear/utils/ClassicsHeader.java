...
public class ClassicsHeader extends RelativeLayout implements RefreshHeader {
    ...
    private void initView(Context context, AttributeSet attrs) {
        REFRESH_HEADER_PULLDOWN = context.getString(R.string.string_pull_to_refresh);
        REFRESH_HEADER_REFRESHING = context.getString(R.string.string_refreshing);
        REFRESH_HEADER_LOADING = context.getString(R.string.string_is_loading);
        REFRESH_HEADER_RELEASE = context.getString(R.string.string_release_to_refresh);
        REFRESH_HEADER_FINISH = context.getString(R.string.string_refresh_done);
        REFRESH_HEADER_FAILED = context.getString(R.string.string_refresh_fail);
        REFRESH_HEADER_LASTTIME = context.getString(R.string.string_last_update);
        mFormat = new SimpleDateFormat(REFRESH_HEADER_LASTTIME, Locale.CHINA);
