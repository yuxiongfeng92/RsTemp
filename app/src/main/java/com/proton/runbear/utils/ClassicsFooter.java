...
public class ClassicsFooter extends RelativeLayout implements RefreshFooter {
    ...
    public String REFRESH_FOOTER_RELEASE = "释放立即加载";
    public String REFRESH_FOOTER_LOADING = "正在加载...";
    public String REFRESH_FOOTER_REFRESHING = "正在刷新...";
    public String REFRESH_FOOTER_FINISH = "加载完成";
    public String REFRESH_FOOTER_FAILED = "加载失败";
    public String REFRESH_FOOTER_ALLLOADED = "全部加载完成";
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        REFRESH_FOOTER_PULLUP = context.getString(R.string.string_load_more);
        REFRESH_FOOTER_RELEASE = context.getString(R.string.string_load_more);
        REFRESH_FOOTER_LOADING = context.getString(R.string.string_is_loading);
        REFRESH_FOOTER_REFRESHING = context.getString(R.string.string_refreshing);
        REFRESH_FOOTER_FINISH = context.getString(R.string.string_load_done);
        REFRESH_FOOTER_FAILED = context.getString(R.string.string_load_failed);
        REFRESH_FOOTER_ALLLOADED = context.getString(R.string.string_all_load_done);
