...
public class PermissionsActivity extends BaseActivity {
    ...
    protected void onResume() {
        super.onResume();
        if (isRequireCheck) {
            if (mChecker.lacksPermissions()) {
                requestPermissions(PermissionsChecker.PERMISSIONS); // 请求权限
            } else {
    ...
    private void showMissingPermissionDialog() {
        ...
        sweetAlertDialog.showCancelButton(true)
                .setTitleText(getString(R.string.string_help))
                .setCancelText(getString(R.string.string_quit))
                .setConfirmText(getString(R.string.string_settings))
                .setContentText(getString(R.string.string_help_text))
