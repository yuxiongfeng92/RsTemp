...
public class TempCurveView extends FrameLayout {
    ...
    public TempCurveView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TempCurveView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initLineChart() {
        ...
        leftAxis.setValueFormatter(new IAxisValueFormatter() {
            ...
            public String getFormattedValue(float value, AxisBase axis) {
                int axisLineColor = axis.getAxisLineColor();
                Logger.w("axisLineColor is : ", axisLineColor);
                String tempAndUnit = Utils.getTempAndUnit(value);
                return tempAndUnit;
            }
        });
