package com.proton.runbear.socailauth.weixin;
...
import com.proton.runbear.socailauth.SSOHandler;
...
import com.proton.runbear.socailauth.share_media.ShareImageMedia;
import com.proton.runbear.socailauth.share_media.ShareMusicMedia;
import com.proton.runbear.socailauth.share_media.ShareTextMedia;
import com.proton.runbear.socailauth.share_media.ShareVideoMedia;
import com.proton.runbear.socailauth.share_media.ShareWebMedia;
import com.proton.runbear.socailauth.util.BitmapUtils;
import com.proton.runbear.socailauth.util.LogUtils;
...
public class WXHandler extends SSOHandler {
    ...
    public void share(Activity activity, IShareMedia shareMedia, ShareListener shareListener) {
        ...
        } else if (shareMedia instanceof ShareFileMedia) {//文件分享
            ShareFileMedia shareFileMedia = (ShareFileMedia) shareMedia;
            WXFileObject wxFileObject = new WXFileObject();
            wxFileObject.fileData = fileToByte(shareFileMedia.getFilePath());
            wxFileObject.filePath = shareFileMedia.getFilePath();
            msg.mediaObject = wxFileObject;
            msg.title = shareFileMedia.getTitle();
        } else {
