...
//    private LinearLayout mLlClose;
    //默认色
    private int mDefaultColor = 0xff42BDCD;
    private int mDefaultPicResId = R.mipmap.rocket;
...
//        mLlClose = view.findViewById(R.id.ll_close);
        ...
        //设置主题色
        initTheme(themeColor, topPic);
    }

    public void setData(UpdateAppBean updateBean, int themeColor, int topPic) {
        mUpdateApp = updateBean;
...
//                mLlClose.setVisibility(View.GONE);
     ...
     * 初始化主题色
     */
    private void initTheme(int themeColor, int topPic) {
        if (themeColor == 0) {
            themeColor = -1;
        }
        if (topPic == 0) {
        ...
        if (-1 == topPic) {
            if (-1 == themeColor) {
                ...
                setDialogTheme(themeColor, mDefaultPicResId);
            }
...
//                    }
//                });
                setDialogTheme(mDefaultColor, topPic);
            } else {
                //更加指定的上色
                setDialogTheme(themeColor, topPic);
            }
        }
...
//            }
    ...
    private void installApp() {
        if (AppUpdateUtils.appIsDownloaded(mUpdateApp)) {
            ...
            if (mUpdateApp.isHideDialog() && !mUpdateApp.isForce()) {
                dismiss();
            }
