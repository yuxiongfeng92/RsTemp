...
//                || !mTargetPath.startsWith(preSuffix)
    ...
    public void showDialogFragment() {
        ...
        if (mActivity != null && !mActivity.isFinishing()) {
            ...
            fragment.setData(mUpdateApp, mThemeColor, mTopPic);
    ...
    private void processData(String result, @NonNull UpdateCallback callback) {
        try {
            ...
            if (mUpdateApp.isUpdate()) {
                String currentVersion = AppUpdateUtils.getVersionName(mActivity) + "." + AppUpdateUtils.getVersionCode(mActivity);
                if (mUpdateApp.getExcludeVersion() != null && mUpdateApp.getExcludeVersion().size() > 0) {
                    for (String version : mUpdateApp.getExcludeVersion()) {
                ...
                if (!TextUtils.isEmpty(newVersion)) {
                    if (AppUpdateUtils.compareVersion(newVersion, currentVersion) != 1) {
                        return;
                    }
                }
