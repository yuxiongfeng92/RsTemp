...
public class UpdateAppBean implements Serializable {
     ...
     * 排除的版本
     */
    private List<String> excludeVersion;
    ...
    public UpdateAppBean setForce(boolean force) {
        this.force = force;
        return this;
    }
    ...
    public List<String> getExcludeVersion() {
        return excludeVersion;
    }

    public void setExcludeVersion(List<String> excludeVersion) {
