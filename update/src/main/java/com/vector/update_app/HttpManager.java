...
public interface HttpManager extends Serializable {
     ...
     * @param callBack 回调
     */
    void asyncGet(@NonNull String url, @NonNull Map<String, Object> params, Map<String, String> header, @NonNull Callback callBack);
     ...
     * @param callBack 回调
     */
    void asyncPost(@NonNull String url, @NonNull Map<String, Object> params, Map<String, String> header, @NonNull Callback callBack);
