...
public class AlgorithmHelper {
     ...
     */
    public static native TempResult getTemp(float temp, long time, int flag, int state, int isPill, int sample, int connectStyle, int algorithmType);
}
